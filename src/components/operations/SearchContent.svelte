...
<button
    ...
    class="btn"><span
      class="btn-icon"><svg
        ...
        fill="#636363"
        class=""><path
          d="M5.9 5.8c.2.2.5.3.7.3s.5-.1.7-.3c.4-.4.4-1 0-1.4L5.2 2.3c-.4-.4-1-.4-1.4 0L1.7 4.4c-.4.4-.4 1 0 1.4s1 .4 1.4 0l.4-.4v5.2l-.4-.4c-.4-.4-1-.4-1.4 0s-.4 1 0 1.4l2.1 2.1c.2.2.4.3.7.3s.5-.1.7-.3l2.1-2.1c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-.4.4V5.4l.4.4zM10 5h4c.6 0 1-.4 1-1s-.4-1-1-1h-4c-.6 0-1 .4-1 1s.4 1 1 1zm4 2h-4c-.6 0-1 .4-1 1s.4 1 1 1h4c.6 0 1-.4 1-1s-.4-1-1-1zm0 4h-4c-.6 0-1 .4-1 1s.4 1 1 1h4c.6 0 1-.4 1-1s-.4-1-1-1z" /></svg></span><span>行高</span></button>
